...
import styles from './funcional-user-card.style.module.css';
...
const FunctionalUserCard: React.FC<UserCardProps>  = (props) => {
  ...
  const handleClick: React.MouseEventHandler<HTMLDivElement> = (e) => {
    ...
    console.log('You have clicked the User Picture from user: ', props);
  };

  return (
    <div className={styles.userCard}>
      <div className={styles.userCardPicture} onClick={handleClick}>
      ...
      <div className={styles.userCardInformation}>
        ...
        { 
          counter > 0 && (<div><h2>{counter} </h2></div>)
        }
      </div>
    </div>
  );
...
export default FunctionalUserCard;
